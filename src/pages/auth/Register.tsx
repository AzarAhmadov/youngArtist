            ...
            <div className="flex w-full md:w-1/2  justify-center">
               <Card className="p-5">
                  <CardHeader className="mb-8">
                     <CardTitle className="text-2xl">Young Artists Huba xoş gəlmisiz!</CardTitle>
                     <CardDescription className="text-base">Hesab yaradın</CardDescription>
                  </CardHeader>
                  <CardContent>
                     <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="mb-8 space-y-3">
                           ...
                           <button className="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-6 py-1 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-900 dark:text-white">
                              <svg
