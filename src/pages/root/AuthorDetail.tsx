               ...
               <AnimatedReveal delay={0.4} blur="6px">
                  ...
                  <div className="my-2 text-[16px] text-textBlack">
                     ...
                     <p className="mb-4">
                        ...
                        Təhsil: Rəssamlıq istedadını gənc yaşlardan nümayiş etdirən Mürsəlova, Azərbaycan Dövlət
                        Rəssamlıq Akademiyasında təhsil almışdır. Burada onun yaradıcı qabiliyyətləri daha da inkişaf
                        etmişdir.
                     </p>
                     ...
                     <p className="mb-4">
                        Sərgilər: O, müxtəlif sərgilərdə iştirak etmişdir, həm yerli, həm də beynəlxalq səviyyədə
                        nümayiş etdirilmişdir. Öz əsərlərində şəxsi təcrübələrini və emosiyalarını önə çıxarır.
                     </p>
                     <p>Şəxsi Həyat:</p>
                     <p className="mb-4">
                        <GoDotFill className="inline px-1" />
                     ...
                     <p className="mb-4">
                        <GoDotFill className="inline px-1" />
                        Mükafatlar:Aliyeva, müxtəlif sənət yarışmalarında və sərgilərdə mükafatlara layiq görülmüşdür.
                        Onun əsərləri həm sənətsevərlər, həm də mütəxəssislər tərəfindən yüksək qiymətləndirilir.
                     </p>
                     <p>İrsi:</p>
                     <p className="mb-4">
                        <GoDotFill className="inline px-1" />
                        Təsiri: Natavan Aliyeva'nın əsərləri Azərbaycan rəssamlıq tarixində öz izini qoymuş və müasir
                        sənət mühitində əhəmiyyətli bir yer tutmuşdur. Onun yaradıcı yanaşması, rənglərin və formaların
                        öyrənilməsi və tətbiqi baxımından gənc rəssamlara ilham verməyə davam edir.
                     </p>
                     <p>
                        Aliyeva Natavan'nın həyatı və karyerası, onun sənət dünyasında nə qədər təsirli olduğunu
                        göstərir. Onun əsərləri, Azərbaycan sənətinin inkişafında və beynəlxalq səviyyədə tanınmasında
